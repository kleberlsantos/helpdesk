...
public class DBService {
    ...
    public void instaciaDB() {
        Tecnico tec1 = new Tecnico(null, "Tecnico 1", "233.614.203-18", "tecnico1@mail.com", encoder.encode("123"));
        ...
        Cliente cli1 = new Cliente(null, "Cliente 1", "814.653.841-03", "cliente1@mail.com", encoder.encode("123"));
